        ...
        <>
            ...
            <div className='h-17   flex items-center  justify-between  md:px-8 md:py-2 px-2 py-2 md:gap-0 gap-3 bg-white border-b border-gray-200'>
                <div className=' flex items-center bg-[#ECEEF0]  rounded-md'>
                    ...
                    <input type="text" placeholder='Search By CustomerName' className=' h-8 bg-[#ECEEF0] md:w-65   w-50  p-2 text-[10px] md:text-[12px] tracking-wider focus:outline-none rounded-r-md font-inter ' onChange={((e) => setsearchterm(e.target.value))} value={searchterm} />
                </div>
           ...
           <div className='flex items-center justify-between pr-10'> 
             <span className='pl-8 pt-3 pr-8 flex flex-col gap-5 mb-5 '>
                <p className='text-[23px]  font-extrabold  h-9'>Dashboard Overview</p>
                <p className='text-[14  px]  text-[#3E484D]'>Welcome back,<span >{name}</span>.Here's what happening in your Store </p>
            </span>
            
           </div>
            {/* 2 */}
            <section className=' w-full h-[83.6vh] overflow-auto min-h-fit    bg-blue-50  flex flex-col   justify-start  md:pl-8 pl-1 pr-8'>

                <div className=' w-full flex  gap-10 flex-wrap md:mt-6 mt-5'>
                    <div className='flex  items-center justify-between shadow-md  md:h-35 w-76  p-6 gap-4 bg-[#F2F4F6] rounded-md   '>
                        <span className='flex flex-col gap-1'>
                            <p className='text-[14px] font-medium text-[#3E484D]'>Total Orders</p>
                            <p className='text-[36px] font-extrabold'>{totalOrder}</p>
                        </span>
                    ...
                    <div className='flex items-center justify-between shadow-md md:h-35 w-76  p-6 gap-7 bg-[#F2F4F6] rounded-md'>
                        <span className='flex flex-col gap-1'>
                            <p className='text-[14px] font-medium text-[#3E484D]'>Today's Orders</p>
                            <p className='text-[36px] font-extrabold'>{todayorder}</p>
                        </span>
                    ...
                    <div className='flex items-center justify-between    shadow-md md:h-35 w-95 p-6 gap-7 bg-[#26819D]  shadow-[#26819D] text-white rounded-md'>
                        <span className='flex flex-col gap-1'>
                            <p className='text-[14px]  text-white font-medium'><span className='font-extrabold'>{currentMonth}</span>  Month Earning</p>
                            <p className='text-[36px] font-extrabold'>₹{todayEarning.toFixed(2)}</p>
                        </span>
                ...
                <div className=' h-140  min-h-fit  md:w-[90%] w-screen  flex flex-col rounded-lg  sm:p-8 sm:pt-10 sm:pr-8 sm:pb-8 mt-10 bg-white shadow-md mb-5'>
                    <div className='flex justify-between'>
                        <span>
                            <p className='text-[20px] font-bold'>Latest Orders</p>
                            <p className='opacity-65 text-[14px] text-[#3E484D  ]'> Recent transactions processed through Bill Saathi </p>
                        </span>
